...
const Index = () => (
  <React.Fragment>
    ...
    <Parallax pages={7}>
      ...
      <HeroContent speed={0.4} offset={0} className="click-through hero-padding">
        <Hero>
          <BigTitle>
      ...
      <Divider speed={0.1} offset={1} factor={1} className="click-through">
        <UpBubblesOne>
      ...
      <Divider speed={0.1} offset={3} className="red">
      </Divider>
      ...
      <Content speed={0.4} offset={6} className="red" >
        <Inner>
      ...
      <Divider speed={0.2} offset={6} className={'foreground--coral'}>
        <UpBubblesOne>
          <SVG icon="bubble" width={3} left="26%" top="32%" />
          <SVG icon="bubble" width={2} left="30%" top="34%" />
          <SVG icon="bubble" width={4} left="32%" top="33%" />
